...
urlpatterns = [
    ...
    re_path(r'^api/v2/export/list/$', download_appellation_views.export_appellation_list, name='export_appellations_list'),
    re_path(r'^api/v2/export/$', download_appellation_views.export_appellation, name='export_appellations'),
