...
var Appellation = Vue.resource('/rest/appellation{/id}');
var DateAppellation = Vue.resource('/rest/dateappellation{/id}');
var Relation = Vue.resource('/rest/relationset{/id}');
var Concept = Vue.resource('/rest/concept{/id}', {}, {
    search: {method: 'GET', url: '/rest/concept/search'}
});
var RelationTemplateResource = Vue.resource('/relationtemplate{/id}/', {}, {
    create: {method: 'POST', url: '/relationtemplate{/id}/create/'}
});
var ConceptType = Vue.resource('/rest/type{/id}');
...
AppellationDisplayItem = {
    props: ['appellation'],
    template: `<li v-tooltip="getLabel()"
